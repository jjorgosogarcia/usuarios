...
<html>
    ...
    <body>
       <form action="../usuario/phpedit.php" method="POST" enctype="multipart/form-data">
            ...
            <span class="labels">Email<sup>*</sup></span><input type="text" name="email" value="<?php echo $usuarios->getEmail();?>"/><br /></span><input  type="hidden" name="clave" value="<?php echo $usuarios->getClave();?>" /><br />
